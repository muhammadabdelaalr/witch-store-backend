...
exports.getSupplierInvoiceHistory = exports.getSupplierInvoices = exports.updateSupplierInvoice = exports.createSupplierInvoice = void 0;
...
const updateSupplierInvoice = async (req, res) => {
    try {
        ...
        const updatedInvoice = await prisma_1.prisma.$transaction(async (tx) => {
            ...
            const updatedItems = await Promise.all(items.map((item) => tx.supplierInvoiceItem.create({
                data: {
                    invoice_id: id,
                    product_id: parseInt(item.product_id),
                    qty: parseInt(item.qty),
            ...
            const newItemsMap = new Map(items.map((i) => [parseInt(i.product_id), i]));
...
exports.getSupplierInvoiceHistory = getSupplierInvoiceHistory;
